...
install_XrayR() {
  ...
  cd /usr/local/XrayR/
    ...
    if  [ $# == 0 ] ;then
        ...
        wget -N --no-check-certificate -O /usr/local/XrayR/AikoXrayR-linux.zip https://github.com/AikoXrayR-Project/XrayR/releases/download/v1.4.1/AikoXrayR-linux-${arch}.zip
        if [[ $? -ne 0 ]]; then
        ...
        last_version=$1
        url="https://github.com/AikoXrayR-Project/XrayR/releases/download/v1.4.1/AikoXrayR-linux-${arch}.zip"
